...
# Enable previews for files and directories with fzf-tab
zstyle ':fzf-tab:complete:*' fzf-preview '[[ -d $realpath ]] && ls --color=always $realpath || bat --color=always --style=numbers --line-range=:500 $realpath'
zstyle ':fzf-tab:complete:*' fzf-preview-window 'right:50%' # Adjust the preview window size
